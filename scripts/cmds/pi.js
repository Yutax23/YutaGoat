async function pi(event, message, args, commandName ) {
  try {
  ...
  const res = await axios.get(`https://for-devs.onrender.com/api/pi?query=${prompt}&apikey=api1&uid=${uid}`);
